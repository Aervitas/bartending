      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 justify-between gap-12 py-8 sm:grid-rows-[auto_auto] md:grid-cols-4 md:grid-rows-[auto_auto] md:py-12 lg:grid-cols-[repeat(4,minmax(0,140px))_1fr] lg:grid-rows-1 xl:gap-20">
          ...
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-[#3F3F3F]">Product</h3>
          ...
          {/* 2nd block */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-[#3F3F3F]">Company</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  className="transition text-[#3F3F3F]/70 hover:text-[#697F6A]"
          ...
          {/* 3rd block */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-[#3F3F3F]">Resources</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  className="transition text-[#3F3F3F]/70 hover:text-[#697F6A]"
          ...
          {/* 4th block */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-[#3F3F3F]">Contact Us</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  className="transition text-[#3F3F3F]/70 hover:text-[#697F6A]"
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 lg:text-right">
            ...
            <div className="text-sm">
              ...
              <ul className="inline-flex gap-1">
                <li>
                  <a
                    className="flex items-center justify-center text-[#697F6A] transition hover:text-[#4D6451]"
                    href="#0"
                    aria-label="Twitter"
                  >
                    <svg
